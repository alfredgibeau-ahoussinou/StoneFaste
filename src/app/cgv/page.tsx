      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-stonefast-gray-dark mb-8">
            Les Conditions Générales de Vente de StoneFast sont en cours de rédaction. 
            Cette page sera bientôt disponible avec toutes les conditions de location.
          </p>
          ...
          <div className="bg-stonefast-gray-light p-6 rounded-lg mb-8">
            ...
            <div className="text-left space-y-4 text-stonefast-gray-dark">
              <div>
                <strong>Durée minimale :</strong> 24h
              </div>
              <div>
                <strong>Documents requis :</strong> Permis de conduire, pièce d'identité
              </div>
              <div>
                <strong>Assurance :</strong> Incluse dans nos tarifs
              </div>
              <div>
                <strong>Contact :</strong> contact@stonefast.fr
              </div>
              <div>
